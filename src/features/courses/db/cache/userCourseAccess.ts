...
export function getUserCourseAccessIdTag({ courseId, userId }: { courseId: string, userId: string }) {
...
export function revalidateUserCourseAccessCache({ courseId, userId }: { courseId: string, userId: string }) {
