...
export function ProductCard({ id, name, priceInDollars, description, imageUrl }: {
    id: string, name: string, priceInDollars: number, description: string, imageUrl: string
}) {
    return (
        <Card className="overflow-hidden flex flex-col w-full max-w-[500px] mx-auto">
            <div className="relative aspect-video w-full">
                <Image src={imageUrl} alt="cover_img" fill />
            </div>
