                    ...
                    <div className="flex gap-1 flex-wrap">
                        {selectedValues.length > 0 ? (
                            selectedValues.map(value => {
                                ...
                                return (
                                    <Badge key={getValue(option)} variant="outline">{getLabel(option)}</Badge>
                                )
                            })
                        ) : (
                    ...
                    <CommandList>
                        ...
                        <CommandGroup>
                            {options.map(option => (
                                ...
                                >
                                    <Check className={cn("mr-2 h-4 w-4", selectedValues.includes(getValue(option)) ? "opacity-100" : "opacity-0")} />
                                    {getLabel(option)}
                                </CommandItem>
                            ))}
                        </CommandGroup>
