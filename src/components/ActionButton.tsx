...
export function ActionButton({ action, requireAreYouSure = false, ...props }: Omit<ComponentPropsWithRef<typeof Button>, "onClick"> & { action: () => Promise<{ error: boolean; message: string }>, requireAreYouSure?: boolean }) {
    {
...
function LoadingTextSwap({ isLoading, children }: { isLoading: boolean, children: ReactNode }) {
    return (
        <div className="grid items-center justify-items-center">
            ...
            <div className={cn("col-start-1 col-end-2 row-start-1 row-end-2 text-center", isLoading ? "visible" : "invisible")}>
